      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1">
            <h2 className="text-2xl font-bold mb-4">Neighbourhood KE</h2>
            <p className="text-gray-200 text-sm">
              Connecting communities across Nakuru and Kenya. Discover local news, products, and opportunities in your neighborhood.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/news" className="text-gray-200 hover:text-white transition">
                  News
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/jobs" className="text-gray-200 hover:text-white transition">
                  Jobs
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-white/20 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-200">
            <p className="mb-4 md:mb-0">
              © 2024 Neighbourhood KE. All rights reserved.
            </p>
